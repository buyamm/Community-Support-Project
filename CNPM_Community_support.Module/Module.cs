...
namespace CNPM_Community_support.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class CNPM_Community_supportModule : ModuleBase {
    public CNPM_Community_supportModule() {
		// 
		// CNPM_Community_supportModule
		// 
