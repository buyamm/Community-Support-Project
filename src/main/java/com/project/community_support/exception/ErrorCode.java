...
public enum ErrorCode {
    USER_EXISTED(1001, "User existed with this phone number or this identifier number", HttpStatus.CONFLICT),

    USER_NOT_FOUND(1002, "User not found!", HttpStatus.NOT_FOUND),
    ORGANIZATION_NOT_FOUND(1002, "Organization not found!", HttpStatus.NOT_FOUND),
    FORM_NOT_FOUND(1002, "Form not found!", HttpStatus.NOT_FOUND),

    WRONG_PHONE_NUMBER(1003, "Wrong phone number",HttpStatus.UNAUTHORIZED),
